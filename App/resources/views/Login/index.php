    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="form-container bg-orange-200 w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
            <div class="w-full h-100">
                ...
                <h1 class="form-title">Connectez-vous à votre compte</h1>
                ...
                <form action="index.php?page=login&action=connexion" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" placeholder="Entrer le mot de passe"
                            minlength="6" class="form-input" required>
                    </div>


                    <div class="form-group">
                        <a href="index.php?page=Forgotpassword&action=index" class="form-link">Mot de passe oublié ?</a>
                    </div>
