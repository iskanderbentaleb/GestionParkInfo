    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="form-container bg-orange-200 w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
            <div class="w-full h-100">
                ...
                <h1 class="form-title">Vérification de Code</h1>
                ...
                <form action="index.php?page=verifycode&action=CheckTheVirifyCode" method="POST">
                    <div class="form-group">
                        <label for="email" class="form-label">Le code de vérification ( veuillez vérifier votre e-mail )</label>
                        <input type="text" name="code" placeholder="Le code" class="form-input" autofocus autocomplete required>
                    </div>
