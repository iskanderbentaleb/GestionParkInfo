...
<?php
$title_page = "Modification d'un Réforme";
...
<form class="max-w-sm  mx-auto mt-10 " action="index.php?page=reforme&action=update" method="post">
    

  <div class="mb-5" >
    <input type="text" name="CodeRef" value="<?= $data['ReformeInfo'][0]->CodeRef ?>" required hidden/>
  </div>
  ...
  <div class="mb-5">
    ...
    <input type="datetime-local" id="Date" value="<?= $data['ReformeInfo'][0]->Date ?>" name="Date" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500 dark:shadow-sm-light"  required />
  </div>
  ...
  <select name="matreils[]" id="matreils" multiple="multiple" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500 dark:shadow-sm-light" required>
    <?php foreach ($data['Matreils'] as $Matreil) : ?>
      ...
      <?php if($Matreil['CodeRef'] == $data['ReformeInfo'][0]->CodeRef){echo "selected";} ?>
      >
...
<div class="flex justify-between">
    ...
    <a class="text-white bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center" href="index.php?page=reforme&action=index">
        Annuler
    </a> 
