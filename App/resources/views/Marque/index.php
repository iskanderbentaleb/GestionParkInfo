...
<div x-data="marqueFilter()" x-init="
    fetch('http://localhost/GESTIONPARKINFO/App/Controllers/Api/MarqueApi.php')
...
<a href="index.php?page=marque&action=create">
    ...
    <div class="relative overflow-x-auto p-4" x-show="!isLoading">
        ...
        <table class="w-full text-sm text-center rtl:text-right text-gray-500 dark:text-gray-400 rounded-xl ">
            ...
            <!-- Table body -->
            <tbody>
                <template x-for="marque in filteredMarques" :key="marque.CodeMrq">
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 ">
                        <td class="px-6 py-4" x-text="marque.CodeMrq"></td>
                        <td class="px-6 py-4" x-text="marque.Designation"></td>
                        <td class="p-2 flex">
                            <a x-bind:href="'index.php?page=marque&CodeMrq=' + marque.CodeMrq + '&action=edit'" class="font-medium mr-5 bg-gray-100 p-4 rounded-xl text-blue-700 dark:text-blue-500 hover:underline">
                                <img src="../images/update.svg" width="20" alt="update">
                            </a>
                            <button x-on:click="DeleteRecordValidation('index.php?page=marque&CodeMrq=' + marque.CodeMrq + '&action=destroy')" class="font-medium bg-gray-100 p-4 rounded-xl text-red-700 dark:text-blue-500 hover:underline">
